      ...
      if ( si.valid_data == true )
      {
         ...
         if ( pre_quantlib_addin_call( reader, si, obj ) )
         {
            ...
            try {
              ...
              obj.ObjectId.in(),
             qldds_utils::vector_cast<std::string,CORBA::StringSeq>(obj.BTPs),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Outstandings),
             qldds_utils::vector_cast<ObjectHandler::property_t,CORBA::DoubleSeq>(obj.Prices),
              static_cast<bool>(obj.Permanent),
              obj.Trigger,
              static_cast<bool>(obj.Overwrite) );
              ;
