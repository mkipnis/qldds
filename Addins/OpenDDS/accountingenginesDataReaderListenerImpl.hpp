...
#else
#include <qlo/Addins/Cpp/accountingengines.hpp>
#endif

#include "accountingenginesTypeSupportC.h"
...
namespace accountingengines
{
  ...
  class qlAccountingEngineDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< accountingengines::qlAccountingEngine, std::string > >
  {
    public:
    
      qlAccountingEngineDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, accountingengines::qlAccountingEngine& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, accountingengines::qlAccountingEngine&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, accountingengines::qlAccountingEngine&, std::exception& e );
