      ...
      if ( si.valid_data == true )
      {
         ...
         if ( pre_quantlib_addin_call( reader, si, obj ) )
         {
            ...
            try {
              ...
              obj.ObjectId.in(),
             qldds_utils::vector_cast_str<ObjectHandler::property_t,CORBA::StringSeq>(obj.SwapLengths),
             ...
             qldds_utils::vector_cast<std::string,CORBA::StringSeq>(obj.CmsCouponPricers),
              obj.YieldCurve.in(),
