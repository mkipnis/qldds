...
#else
#include <qlo/Addins/Cpp/statistics.hpp>
#endif

#include "statisticsTypeSupportC.h"
...
namespace statistics
{
  ...
  class qlIncrementalStatisticsDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< statistics::qlIncrementalStatistics, std::string > >
  {
    public:
    
      qlIncrementalStatisticsDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, statistics::qlIncrementalStatistics& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, statistics::qlIncrementalStatistics&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, statistics::qlIncrementalStatistics&, std::exception& e );
  ...
  class qlStatisticsDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< statistics::qlStatistics, std::string > >
  {
    public:
    
      qlStatisticsDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      virtual void on_data_available( DDS::DataReader_ptr reader) throw (CORBA::SystemException);
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, statistics::qlStatistics& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, statistics::qlStatistics&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, statistics::qlStatistics&, std::exception& e );
