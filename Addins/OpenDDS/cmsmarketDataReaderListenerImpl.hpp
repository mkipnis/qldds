...
#else
#include <qlo/Addins/Cpp/cmsmarket.hpp>
#endif

#include "cmsmarketTypeSupportC.h"
...
namespace cmsmarket
{
  ...
  class qlCmsMarketDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< cmsmarket::qlCmsMarket, std::string > >
  {
    public:
    
      qlCmsMarketDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, cmsmarket::qlCmsMarket& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, cmsmarket::qlCmsMarket&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, cmsmarket::qlCmsMarket&, std::exception& e );
