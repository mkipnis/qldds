...
#else
#include <qlo/Addins/Cpp/settings.hpp>
#endif

#include "settingsTypeSupportC.h"
...
namespace settings
{
  ...
  class qlSettingsEvaluationDateDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< settings::qlSettingsEvaluationDate, long > >
  {
    public:
    
      qlSettingsEvaluationDateDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, settings::qlSettingsEvaluationDate& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, settings::qlSettingsEvaluationDate&, long& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, settings::qlSettingsEvaluationDate&, std::exception& e );
  ...
  class qlSettingsSetEvaluationDateDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< settings::qlSettingsSetEvaluationDate, bool > >
  {
    public:
    
      qlSettingsSetEvaluationDateDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      virtual void on_data_available( DDS::DataReader_ptr reader) throw (CORBA::SystemException);
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, settings::qlSettingsSetEvaluationDate& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, settings::qlSettingsSetEvaluationDate&, bool& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, settings::qlSettingsSetEvaluationDate&, std::exception& e );
