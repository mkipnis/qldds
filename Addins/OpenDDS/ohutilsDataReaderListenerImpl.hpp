...
#else
#include <qlo/Addins/Cpp/ohutils.hpp>
#endif

#include "ohutilsTypeSupportC.h"
...
namespace ohutils
{
  ...
  class ohVersionDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< ohutils::ohVersion, std::string > >
  {
    public:
    
      ohVersionDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, ohutils::ohVersion& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, ohutils::ohVersion&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, ohutils::ohVersion&, std::exception& e );
