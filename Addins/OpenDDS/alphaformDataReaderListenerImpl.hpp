...
#else
#include <qlo/Addins/Cpp/alphaform.hpp>
#endif

#include "alphaformTypeSupportC.h"
...
namespace alphaform
{
  ...
  class qlAlphaFormInverseLinearDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< alphaform::qlAlphaFormInverseLinear, std::string > >
  {
    public:
    
      qlAlphaFormInverseLinearDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, alphaform::qlAlphaFormInverseLinear& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, alphaform::qlAlphaFormInverseLinear&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, alphaform::qlAlphaFormInverseLinear&, std::exception& e );
  ...
  class qlAlphaFormLinearHyperbolicDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< alphaform::qlAlphaFormLinearHyperbolic, std::string > >
  {
    public:
    
      qlAlphaFormLinearHyperbolicDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      virtual void on_data_available( DDS::DataReader_ptr reader) throw (CORBA::SystemException);
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, alphaform::qlAlphaFormLinearHyperbolic& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, alphaform::qlAlphaFormLinearHyperbolic&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, alphaform::qlAlphaFormLinearHyperbolic&, std::exception& e );
