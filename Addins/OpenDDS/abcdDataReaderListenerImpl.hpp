...
#else
#include <qlo/Addins/Cpp/abcd.hpp>
#endif

#include "abcdTypeSupportC.h"
...
namespace abcd
{
  ...
  class qlAbcdCalibrationDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< abcd::qlAbcdCalibration, std::string > >
  {
    public:
    
      qlAbcdCalibrationDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, abcd::qlAbcdCalibration& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, abcd::qlAbcdCalibration&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, abcd::qlAbcdCalibration&, std::exception& e );
  ...
  class qlAbcdFunctionDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< abcd::qlAbcdFunction, std::string > >
  {
    public:
    
      qlAbcdFunctionDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      virtual void on_data_available( DDS::DataReader_ptr reader) throw (CORBA::SystemException);
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, abcd::qlAbcdFunction& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, abcd::qlAbcdFunction&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, abcd::qlAbcdFunction&, std::exception& e );
