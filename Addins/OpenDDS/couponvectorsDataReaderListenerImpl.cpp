      ...
      if ( si.valid_data == true )
      {
         ...
         if ( pre_quantlib_addin_call( reader, si, obj ) )
         {
            ...
            try {
              ...
              obj.ObjectId.in(),
              obj.PaymentBDC.in(),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Nominals),
              obj.ScheduleID.in(),
              qldds_utils::vector_cast<long,CORBA::LongSeq>(obj.FixingDays),
         ...
         if ( pre_quantlib_addin_call( reader, si, obj ) )
         {
            ...
            try {
             ...
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Gearings),
              obj.SwapIndex.in(),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Spreads),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.CallStrikes),
              obj.CallSpecs.in(),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.CallPayoff),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.PutStrikes),
              obj.PutSpecs.in(),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.PutPayoff),
              obj.Replication.in(),
              static_cast<bool>(obj.Permanent),
              obj.Trigger,
              static_cast<bool>(obj.Overwrite) );
         ...
         if ( pre_quantlib_addin_call( reader, si, obj ) )
         {
            ...
            try {
             ...
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Nominals),
              ...
              qldds_utils::vector_cast<long,CORBA::LongSeq>(obj.FixingDays),
              obj.DayCounter.in(),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.LowerStrikes),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Gearings),
              obj.IborIndex.in(),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.Spreads),
             qldds_utils::vector_cast<double,CORBA::DoubleSeq>(obj.UpperStrikes),
