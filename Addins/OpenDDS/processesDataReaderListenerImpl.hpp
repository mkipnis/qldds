...
#else
#include <qlo/Addins/Cpp/processes.hpp>
#endif

#include "processesTypeSupportC.h"
...
namespace processes
{
  ...
  class qlGeneralizedBlackScholesProcessDataReaderListenerImpl
    : public virtual OpenDDS::DCPS::LocalObject<qldds::DataReaderListener< processes::qlGeneralizedBlackScholesProcess, std::string > >
  {
    public:
    
      qlGeneralizedBlackScholesProcessDataReaderListenerImpl( ACE_Mutex& mutex ) : _mutex( mutex ) {}; 
      ...
      virtual bool pre_quantlib_addin_call( DDS::DataReader_ptr reader, DDS::SampleInfo&, processes::qlGeneralizedBlackScholesProcess& );

      virtual bool post_quantlib_addin_call( DDS::DataReader_ptr reader, processes::qlGeneralizedBlackScholesProcess&, std::string& );

      virtual void on_std_exception( DDS::DataReader_ptr reader, processes::qlGeneralizedBlackScholesProcess&, std::exception& e );
